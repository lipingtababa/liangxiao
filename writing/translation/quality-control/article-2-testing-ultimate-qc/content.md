...
**Original URL**: https://mp.weixin.qq.com/s/04RfmpqMEAhOT3DqyYk_-g
**Author**: 瑞典马工
**Date**: (not available in parsed HTML)

---

你在公司推AI Coding，老板问你一个问题：代码质量怎么保证？你答不上来。你想过，但越想越觉得这个问题没有简单答案。AI写代码确实快，但快了之后，测试谁做？review谁做？出了bug谁负责？

这也是我们Agent管理学论坛第12期的主题。这个研讨会我们办了十几期，这一期聚焦端到端测试，晓灰分享，Ryan主持。大家研讨了两个半小时，有很多共识，也有很多分析。

## 先说说大家都同意的

**测试在AI时代是第一公民。** AI让代码生产成本趋近于零，没有测试验收的代码就是泔水。这一点在场所有连续用AI维护过生产代码几个月的人都有切身体会：你噗的越多，代码越丑陋，维护成本比松弛的成本还高。代码你甚至可以不怎么看，但测试一定要看。

**AI降低了测试成本，但目前没有发明任何新的测试方法。** 分层测试、mock、自动化、覆盖率，全是教科书上现成的。AI的贡献是把以前只有金融行业才能落地的good practice，变成了所有团队都能用的东西。端到端测试、GWT用户故事、自动化循环，方法论都是老一套，AI只是让执行成本暴跌。

**先写测试用例再写代码有价值，但TDD的红绿循环需要重估。** TDD的核心价值是逼你想清楚需求，AI时代代码写得太快了，一步一个红绿循环反而拖慢节奏。但"先定义预期行为，再让AI实现"，这个思路大家都认同。

更有意思的，是讨论中浮现出的五个没人能回答的问题。
...
你在实践中碰到了哪些类似的无人区问题？欢迎在公众号给我留言，我们一起交流讨论。
